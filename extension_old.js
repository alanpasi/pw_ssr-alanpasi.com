...
const sampleRates = [44100, 48000, 88000, 96000];
...
const Indicator = GObject.registerClass(
  class Indicator extends PanelMenu.Button {
    _init(path) {
      ...
      //
      // for (let rate of sampleRates) {
      //   let item = new PopupMenu.PopupMenuItem(`${rate} Hz`, {
      //     style_class: "preset-submenu-item",
      //   });
      //   this.menu.addMenuItem(item);
      //   item.connect("activate", () => {
      //     this._setSampleRate(rate);
      //   });
      //   this._sampleRateItems[rate] = item;
      // }
      //
